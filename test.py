...
#from models.seg_hrnet import seg_hrnet
from Model.seg_unet import unet
from dataProcess import testGenerator, saveResult, color_dict
import os

#  训练模型保存地址
model_path = r'D:/study/Grass identification/Unet_RSimage_Multi-band_Multi-class-master/Model/unet_model.hdf5'
#  测试数据路径
test_iamge_path = r'D:/study/Grass identification/Unet_RSimage_Multi-band_Multi-class-master/Data/test/image'
#  结果保存路径
save_path = r'D:/study/Grass identification/Unet_RSimage_Multi-band_Multi-class-master/Data/test/predict'
#  测试数据数目
